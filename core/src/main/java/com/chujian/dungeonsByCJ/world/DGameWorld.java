...
import com.chujian.dungeonsByCJ.api.dungeon.*;
import com.chujian.dungeonsByCJ.api.event.world.GameWorldStartGameEvent;
import com.chujian.dungeonsByCJ.api.event.world.InstanceWorldPostUnloadEvent;
import com.chujian.dungeonsByCJ.api.event.world.InstanceWorldUnloadEvent;
...
import com.chujian.dungeonsByCJ.mob.CitizensMobProvider;
import com.chujian.dungeonsByCJ.sign.button.ReadySign;
import com.chujian.dungeonsByCJ.sign.passive.StartSign;
import com.chujian.dungeonsByCJ.sign.windup.MobSign;
import com.chujian.dungeonsByCJ.trigger.*;
import com.chujian.dungeonsByCJ.world.block.*;
...
public class DGameWorld extends DInstanceWorld implements GameWorld {
    ...
    public int getMobCount() {
        ...
        signs:  for (DungeonSign sign : getDungeonSigns().toArray(new DungeonSign[getDungeonSigns().size()])) {
                    ...
                    for (com.chujian.dungeonsByCJ.api.Trigger trigger : sign.getTriggers()) {
