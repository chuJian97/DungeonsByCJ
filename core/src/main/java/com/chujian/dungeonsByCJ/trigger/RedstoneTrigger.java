 ...
 */
package com.chujian.dungeonsByCJ.trigger;

import de.erethon.caliburn.category.Category;
import com.chujian.dungeonsByCJ.api.sign.Deactivatable;
import com.chujian.dungeonsByCJ.api.sign.DungeonSign;
import com.chujian.dungeonsByCJ.event.trigger.TriggerActionEvent;
    ...
    public void onTrigger() {
        ...
        if (rtBlock.isBlockPowered()) {
            ...
            for (DungeonSign dSign : getDSigns().toArray(new DungeonSign[getDSigns().size()])) {
                ...
                for (com.chujian.dungeonsByCJ.api.Trigger trigger : dSign.getTriggers()) {
