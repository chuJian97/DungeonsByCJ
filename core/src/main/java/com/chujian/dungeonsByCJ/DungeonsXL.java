...
import com.chujian.dungeonsByCJ.command.DCommandCache;
import com.chujian.dungeonsByCJ.config.MainConfig;
import com.chujian.dungeonsByCJ.dungeon.DDungeon;
import com.chujian.dungeonsByCJ.global.GlobalProtectionCache;
import com.chujian.dungeonsByCJ.global.GlobalProtectionListener;
import com.chujian.dungeonsByCJ.mob.*;
import com.chujian.dungeonsByCJ.player.*;
import com.chujian.dungeonsByCJ.player.groupadapter.PartiesAdapter;
import com.chujian.dungeonsByCJ.reward.RewardListener;
import com.chujian.dungeonsByCJ.sign.DSignListener;
import com.chujian.dungeonsByCJ.sign.button.EndSign;
import com.chujian.dungeonsByCJ.sign.passive.RewardChestSign;
import com.chujian.dungeonsByCJ.sign.passive.SignScript;
import com.chujian.dungeonsByCJ.sign.windup.CommandScript;
import com.chujian.dungeonsByCJ.sign.windup.MobSign;
import com.chujian.dungeonsByCJ.trigger.TriggerListener;
import com.chujian.dungeonsByCJ.trigger.TriggerTypeCache;
import com.chujian.dungeonsByCJ.util.LWCUtil;
import com.chujian.dungeonsByCJ.util.PlaceholderUtil;
import com.chujian.dungeonsByCJ.world.*;
import de.erethon.caliburn.CaliburnAPI;
import de.erethon.caliburn.mob.ExMob;
import com.chujian.dungeonsByCJ.adapter.block.BlockAdapter;
import com.chujian.dungeonsByCJ.adapter.block.BlockAdapterBlockData;
import com.chujian.dungeonsByCJ.adapter.block.BlockAdapterMagicValues;
...
import com.chujian.dungeonsByCJ.api.mob.ExternalMobProvider;
import com.chujian.dungeonsByCJ.api.player.GroupAdapter;
...
import com.chujian.dungeonsByCJ.util.commons.misc.FileUtil;
import com.chujian.dungeonsByCJ.util.commons.misc.Registry;
import com.chujian.dungeonsByCJ.util.commons.spiget.comparator.VersionComparator;
import com.chujian.dungeonsByCJ.world.*;
...
public class DungeonsXL extends DREPlugin implements DungeonsAPI {
    ...
    public void deleteAllInstances() {
        MainConfig.BackupMode backupMode = mainConfig.getBackupMode();
        for (InstanceWorld instance : instanceCache.getAll()) {
            if (backupMode == MainConfig.BackupMode.ON_DISABLE | backupMode == MainConfig.BackupMode.ON_DISABLE_AND_SAVE && instance instanceof EditWorld) {
