 ...
 * <p>
 * A game world is not equal to a {@link Dungeon}.
 *
...
public interface GameWorld extends InstanceWorld {
    ...
    /**
     * Returns the start location of the world. This may be set by a start {@link DungeonSign sign} or, if none exists, the
