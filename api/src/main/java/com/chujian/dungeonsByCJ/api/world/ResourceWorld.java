 ...
 */
package com.chujian.dungeonsByCJ.api.world;
 ...
 * <p>
 * A resource world is not equal to a {@link Dungeon}.
 *
...
public interface ResourceWorld {
    ...
    /**
     * Returns the {@link GameRule}s of this world.
     * <p>
     ...
     * {@link GameRule#DEFAULT_VALUES}.
     *
     * @return the {@link GameRule}s of this world
     */
     ...
     *
     * @see Game#ensureWorldIsLoaded(boolean)
